...
EN_STRINGTABLE = {
    ...
    "ban_with_expire": "Brugeren er udelukket {duration}.",
    "ban_with_reason_expire": "Brugeren er udelukket af {reason} {duration}.",
    ...
    "user_is_user_is_already_member": "User is already a member.",
    "new_discord_new_discord_user_must_not_be_member": "The new Discord account must not be connected to a member.",
    ...
    "garage_has_trucks": "There are trucks parked in the garage and they must be relocated before the garage can be sold.",
    ...
    "garage_slot_has_trucks": "There are trucks parked in the garage slot and they must be relocated before the slot can be sold.",
    ...
    "rejected_navio_webhook_post": "Rejected Navio webhook update from {ip}",
