...
EN_STRINGTABLE = {
    ...
    "invalid_email": "Invalid email connected to Discord account. Connect your Discord account with an email address and login again.",
    ...
    "auth_link_invalid_or_expired": "Authorization link invalid or expired.",
    ...
    "connection_invalid": "User must have connected their {app} account.",
    ...
    "must_have_connection": "You must connect a {app} account before submitting an application.",
