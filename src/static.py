...
EN_STRINGTABLE = {
    ...
    "current_user_didnt_join_discord": "You have not joined join the Discord server.",
    "email_not_unique": "Your email is connected to multiple users, and you cannot enable password login.",
    ...
    "daily_bonus_not_available": "Daily Bonus Unavailable for Your Rank",
    ...
    "must_connect_steam_before_truckersmp": "Connect Steam Account Before TruckersMP",
    ...
    "add_role_higher_or_equal": "One or more roles of the user to add is higher than or equal to your highest role.",
    "remove_role_higher_or_equal": "One or more roles of the user to remove is higher than or equal to your highest role.",
    "only_division_staff_allowed": "Only division staff and admins are allowed to manage division roles.",
    "already_have_rank_role": "The rank role has already been given in Discord.",
    "losing_admin_permission": "Role Update Rejected: You will lose admin permission.",
