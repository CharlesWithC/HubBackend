...
EN_STRINGTABLE = {
    ...
    "applicant_not_eligible": "You are not eligible to submit this type of application.",
    "no_multiple_application": "You are not allowed to submit multiple applications of this type within {count} hours.",
    "same_type_application_exists": "You are not allowed to submit another application of this type when there is a pending one.",
    ...
    "point_updated": "You have been given `{distance}km` and `{bonus_points}` bonus points.",
