...
if __name__ == "__main__":
    ...
    scopes = routing.initRoutes(config_paths, openapi_path, first_init = True, enable_performance_header = args.enable_performance_header)

scopes = routing.initRoutes(config_paths, openapi_path, enable_performance_header = args.enable_performance_header)
